...
```cmdstack
VkBuffer / VkImage       ← 핸들(리소스 자체, 메모리 미할당)
---
vkGetBufferMemoryRequirements
/ vkGetImageMemoryRequirements
---
VkDeviceMemory 할당 + vkBindBufferMemory / vkBindImageMemory
---
(필요 시) VkImageView 생성
---
Descriptor Set 갱신 / vkCmdBind* / vkCmdCopy* / 렌더 패스 첨부
---
(필요 시) vkDestroyImageView → vkDestroyImage / vkDestroyBuffer → vkFreeMemory
```
